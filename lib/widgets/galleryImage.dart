...
class GalleryImage extends StatefulWidget {
  ...
  const GalleryImage({
    ...
    required this.image, required this.imagesScrolled, required this.index,
  });
      ...
      builder: (context, constraints) {
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: Transform.scale(
                  scale: 0.7 + 0.3 * (1 - (widget.index - widget.imagesScrolled).abs()),
                  child: Hero(
                    transitionOnUserGestures: true,
                    tag: widget.image.imagePath,
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(((widget.index - widget.imagesScrolled).abs()) * 80),
                      child: IntrinsicHeight(
                        child: Image.asset(
                          ...
                          fit:
                              isMobile(context) ? BoxFit.contain : BoxFit.cover,
                          height:
                              isMobile(context)
                                  ? null
        ...
        return Stack(
          ...
          children: [
            ...
            Transform.translate(
              offset: Offset(((widget.index - widget.imagesScrolled).abs()) * 540,0),
